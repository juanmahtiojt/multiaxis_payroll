...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $activity = "Uploaded attendance file: $fileName";

        $sql = "INSERT INTO activity_logs (username, activity, page, ip_address, timestamp) VALUES (?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("sssss", $user, $activity, $page, $ip_address, $timestamp);
        $stmt->execute();
        // === END ACTIVITY LOG INSERTION ===
