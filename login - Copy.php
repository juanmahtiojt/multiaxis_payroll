...
$lockout_time = 60; // 30 minutes in seconds
...
function log_activity($conn, $username, $activity_type) {
    ...
    if (mysqli_num_rows($table_result) > 0) {
        $log_query = "INSERT INTO activity_logs (username, activity_type, timestamp, ip_address) VALUES (?, ?, NOW(), ?)";
        ...
        /*
        $create_table_query = "CREATE TABLE activity_logs (
